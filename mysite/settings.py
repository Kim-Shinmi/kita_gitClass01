...
SECRET_KEY = 'ydv0nq%rm=nv#55mb#8fyjyce^ngpiu69g)o3ww!ijj^2_5sft'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True      #>> 실 사용시에는 User에게 Debug 내용이 보여지지 않게 하기 위해 'False'로 변경함.

ALLOWED_HOSTS = []


# Application definition   #>> 생성한 App을 사용하기 위해 등록해야 하는 부분
